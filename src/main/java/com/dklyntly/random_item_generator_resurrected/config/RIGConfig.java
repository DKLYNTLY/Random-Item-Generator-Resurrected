...
public final class RIGConfig {
    ...
    // ==================== ITEM BLOCK ====================
    public static final ForgeConfigSpec.BooleanValue ITEM_USE_WHITELIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> ITEM_DENYLIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> ITEM_MOD_DENYLIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> ITEM_WHITELIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> ITEM_MOD_WHITELIST;

    // ==================== ENTITY BLOCK ====================
    public static final ForgeConfigSpec.BooleanValue ENTITY_BLOCK_NON_MOBS;
    public static final ForgeConfigSpec.BooleanValue ENTITY_BLOCK_LIGHTNING;
    public static final ForgeConfigSpec.BooleanValue ENTITY_BLOCK_EXPLOSIVES;
    public static final ForgeConfigSpec.BooleanValue ENTITY_BLOCK_FIREBALLS;
    public static final ForgeConfigSpec.BooleanValue ENTITY_BLOCK_PROJECTILES;
    public static final ForgeConfigSpec.BooleanValue ENTITY_BLOCK_SPLASH_POTIONS;
    public static final ForgeConfigSpec.BooleanValue ENTITY_BLOCK_XP_BOTTLES;
    public static final ForgeConfigSpec.BooleanValue ENTITY_BLOCK_ARMOR_STANDS;
    public static final ForgeConfigSpec.BooleanValue ENTITY_BLOCK_VEHICLES;
    public static final ForgeConfigSpec.BooleanValue ENTITY_BLOCK_FALLING_BLOCKS;
    public static final ForgeConfigSpec.BooleanValue ENTITY_BLOCK_ITEM_FRAMES;
    public static final ForgeConfigSpec.BooleanValue ENTITY_BLOCK_PAINTINGS;
    public static final ForgeConfigSpec.BooleanValue ENTITY_BLOCK_CREATURES;
    public static final ForgeConfigSpec.BooleanValue ENTITY_BLOCK_MONSTERS;
    public static final ForgeConfigSpec.BooleanValue ENTITY_USE_WHITELIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> ENTITY_DENYLIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> ENTITY_MOD_DENYLIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> ENTITY_WHITELIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> ENTITY_MOD_WHITELIST;

    // ==================== ENCHANTS BLOCK ====================
    public static final ForgeConfigSpec.BooleanValue ENCHANTS_REMOVE_CURSES;
    public static final ForgeConfigSpec.BooleanValue ENCHANTS_USE_WHITELIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> ENCHANT_DENYLIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> ENCHANT_MOD_DENYLIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> ENCHANT_WHITELIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> ENCHANT_MOD_WHITELIST;

    // ==================== LOOT BLOCK ====================
    public static final ForgeConfigSpec.BooleanValue LOOT_USE_WHITELIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> LOOT_DENYLIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> LOOT_MOD_DENYLIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> LOOT_WHITELIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> LOOT_MOD_WHITELIST;
    ...
    public static boolean isEnchantAllowed(Enchantment ench) {
    ...
    @Deprecated public static boolean isEnchantBlacklisted(Enchantment e)   { return !isEnchantAllowed(e); }
    @Deprecated public static boolean isEnchantModBlacklisted(Enchantment e){ return !isEnchantAllowed(e); }
